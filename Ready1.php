...
body {
  font-weight:600;
  background-color: rgb(211, 166, 83); 
}
...
<body>
         <p>10 Second To Get Ready For Game</p>
       <div id="app"></div>
       <h1 style="margin: 50px;"> <a href="sub.html" style="text-decoration: none;">Skip</a> </h1>
